...
def build_masked_input_response(client_id: int, received_data: dict[int, dict[int, dict]], round3_responders: set[int]) -> dict:
  return {'u2_users': sorted(list(round3_responders))}




def build_consistency_check_response(received_data: dict, round3_responders: set[int], round4_responders: set[int]) -> dict:
