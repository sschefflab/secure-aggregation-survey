...
from _server_helper import extract_round_client_id_payload, response_if_not_responder, build_keyset_response, build_sharekeys_response, build_masked_input_response, build_consistency_check_response
...
class SecureAggregationServer:
   ...
   def _check_round5(self, client_id: int) -> dict:
       ...
       if not self.roundi_responders_locked[4].is_set():
           return {'status': 'error', 'message': 'Round 5 received before round 4 threshold wait completed.'}
